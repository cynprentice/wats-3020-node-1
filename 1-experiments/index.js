...
console.log("string is ", isTruthy(STRING_VALUE))
console.log("int is ", isTruthy(INT_VALUE))
console.log("empty string is  ", isTruthy(EMPTY_STRING_VALUE))
console.log("undefined is ", isTruthy(UNDEFINED))
console.log("null is ", isTruthy(NULL))
console.log("0 is  ", isTruthy(INT_ZERO))
console.log("NaN is   ", isTruthy(NAN))
